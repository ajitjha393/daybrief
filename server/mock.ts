...
export function mockResults(now: number = Date.now()): ProviderResult {
  return {
    pulls: [
      ...
      {
        source: 'ado', id: 4844, key: 'fleet-web!4844',
        title: 'chore(deps): bump vite from 6.3.1 to 6.3.4',
        url: 'https://dev.azure.com/acme/Fleet/_git/fleet-web/pullrequest/4844',
        repo: 'fleet-web',
        author: { name: 'dependabot[bot]', id: 'dependabot@acme.dev' },
        createdAt: now - 5 * H, updatedAt: null, closedAt: null, isDraft: false, mergeBlocked: false,
        targetBranch: 'develop',
        groupReviewers: [],
        reviewers: [],
        ci: 'ok',
      ...
      {
        source: 'ado', id: 4846, key: 'fleet-web!4846',
        title: '[FLT-791] Hotfix: stop-card z-order under drag',
        url: 'https://dev.azure.com/acme/Fleet/_git/fleet-web/pullrequest/4846',
        repo: 'fleet-web',
        author: { name: 'Priya Nair', id: 'priya@acme.dev' },
        createdAt: now - 9 * H, updatedAt: null, closedAt: null, isDraft: false, mergeBlocked: false,
        targetBranch: 'release/3.2',
        groupReviewers: [],
        reviewers: [{ name: 'Marco Ruiz', id: 'marco@acme.dev', vote: 'approved', required: true }],
        ci: 'running',
      },
      {
    ...
    mergedPulls: [
      ...
      {
        source: 'ado', id: 4788, key: 'fleet-web!4788',
        title: '[FLT-780] Driver login retry backoff',
        url: 'https://dev.azure.com/acme/Fleet/_git/fleet-web/pullrequest/4788',
        repo: 'fleet-web',
        author: { name: 'Marco Ruiz', id: 'marco@acme.dev' },
        createdAt: now - 4 * D, updatedAt: null, closedAt: now - 2 * D, isDraft: false, mergeBlocked: false,
        targetBranch: 'release/3.2',
        groupReviewers: [],
        reviewers: [],
        ci: 'none',
      ...
      {
        source: 'ado', id: 4781, key: 'fleet-api!4781',
        title: '[FLT-802] Depot map clustering for dense metros',
        url: 'https://dev.azure.com/acme/Fleet/_git/fleet-api/pullrequest/4781',
        repo: 'fleet-api',
        author: { name: 'Ben Okafor', id: 'ben@acme.dev' },
        createdAt: now - 6 * D, updatedAt: null, closedAt: now - 3 * D, isDraft: false, mergeBlocked: false,
        targetBranch: 'develop',
        groupReviewers: [],
        reviewers: [],
        ci: 'none',
    ...
    runs: [
      ...
      { source: 'ado', id: 91243, pipeline: 'fleet-web · release/3.2', status: 'ok', branch: 'release/3.2', finishedAt: now - 3 * H, url: 'https://dev.azure.com/acme/Fleet/_build/results?buildId=91243' },
